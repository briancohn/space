...
\author{Cohn BA$^{1}$, Szedl\'{a}k M$^{2}$, Fukuda K$^{2}$, G{\"a}rtner B$^{2}$, and  Valero-Cuevas FJ$^{1}$% <-this % stops a space
...
\thanks{$^{2}$Department of 	Computer Science, ETH Zurich,[maytodo add the umlaut and the official name] Switzerland}%
}
