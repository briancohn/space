...
The classical notion of muscle redundancy  proposes that, faced with an infinite number of possible muscle activation patterns for a given movement or force production task, the nervous system optimizes in some fashion to select one solution.
