...
For a progression of increasing palmar force (from 10\% to 100\% of maximal), we examine the distribution across each muscle's activation, as the feasible activation space shrinks to the unique maximal solution.
