...
\subsection{Distribution unimodal peak} % (fold)
...
% subsection distribution_unimodal_peak (end)

\subsection{Cross-muscle comparisons with bounding boxes} % (fold)
...
% subsection cross_muscle_comparisons_with_bounding_boxes (end)
