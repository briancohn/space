...
Unfortunately the hidden constant is large, which makes a guaranteed walk practically infeasible.
...
In particular, the paper \cite{emiris2013efficient} by Emiris and Fisikopoulos suggest that $(10 + \frac{10}{n})n$ steps are enough to converge upon the uniform distribution \cite{emiris2013efficient}, while in Ge et al.'s paper every singlepoint of the Hit-and-Run algorithm is used in the sample \cite{Ge}. 
