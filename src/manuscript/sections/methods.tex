...
In this model, for each input we ran 1,000,000 Hit-and-Run iterations and sampled every 100th point- thus generating 10,000 points which are not autocorrelated; the 'mixing time to 100 iterations.
