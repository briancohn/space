...
With the index finger model we collected a sample of [briantodo #] points.
...
\caption{Table X. Cost functions and their usage, where $a_i$ and $Fo_i$ represent a muscle's activation in a given solution, and that muscles MIC, respectively. [briantodo: cite cost functions]}
